...
function my_custom_checkout_field_update_order_meta( $order_id ) {
	if ($_POST['child_name']) update_post_meta( $order_id, 'Child Name', esc_attr($_POST['child_name']));
	if ($_POST['child_age']) update_post_meta( $order_id, 'Child Age', esc_attr($_POST['child_age']));
